<!DOCTYPE html>
<html lang="en">
<?php include('controllers/guest_checkout.controller.php'); 
			...
			<div class="box">
             <form style="border:1px solid #ccc" method='POST'> <!--add POST Action -->
			  <div class="container">
                ...
                <label for="delivery"><b>Name</b></label><br>
                ...
                <label for="delivery"><b>Contact No</b></label><br>
				<input type="number" placeholder="Enter Contact No" name="contact" required><br>
